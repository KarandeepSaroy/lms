      ...
      <div className='text-gray-800'>
                  ...
                  {chapter.chapterContent.map((lecture, i)=> (
                    <li key={i} className='flex items-start gap-2 py-1'>
                      <img src={progressData && progressData.lectureCompleted.includes
                        (lecture.lectureId) ? assets.blue_tick_icon : assets.play_icon} alt="play icon" className='w-4 h-4 mt-1' />
        ...
        <div className='flex items-center gap-2 py-3 mt-10'>
          <h1 className='text-xl font-bold'>Rate this Course:</h1>
            <Rating initialRating={initialRating} onClick = {handleRate}/>
        </div>
        ...
        {playerData ? (
          <div>
            ...
            <div className='flex justify-between items-center mt-1'>
              ...
              <button onClick={()=> (markLectureCompleted(playerData.lectureId))} 
