...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500 mt-3'>Hear from our learners as they share their journeys of transformaton, success, and how our <br /> platform has madea a difference in their lives.</p>
